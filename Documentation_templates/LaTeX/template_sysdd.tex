...
\begin{itemize}
\item SD: {Title \cite{.....}}
\item IDD: {Title \cite{.....}} % multiple IDD arre possible e.g. HTTP
\item IDD: {Title \cite{.....}} % e.g. MQTT
\end{itemize}
...
\begin{table*}[ht!]
  ...
  \begin{tabular}{|r|r|r|r|}
    ...
    aaa & SysD XXX & SD aaa & IDD a1 \\ \hline % multiple IDD's can excist for and SD, e.g. HTTP 
    aaa & SysD XXX & SD aaa & IDD a2 \\ \hline % e.g. MQTT 
    ...
    \hline
    zzz & SysD ZZZ & SD zzz & IDD zzz1 \\ \hline % multiple IDD's can excist for and SD, e.g. HTTP
    zzz & SysD ZZZ & SD zzz & IDD zzz2 \\ \hline % e.g. websocket
