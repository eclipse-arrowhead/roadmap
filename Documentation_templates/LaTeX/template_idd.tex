...
In particular, each subsection first names the [ppp] protcol method and path used to call the function, after which it names an abstract function from the Service Discovery Register SD document, as well as input and output types.
...
\color{red}
All interfaces to be described as provided by the follwoing examples
