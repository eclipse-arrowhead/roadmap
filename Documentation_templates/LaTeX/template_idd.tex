...
\osubsection{Register}{POST}{/serviceregistry/register}{ServiceRegistryRequest}{\pref{Void} or \mref{Error}}
...
\osubsection{Unregister}{DELETE}{/serviceregistry/unregister\\
 \hspace*{0.1\textwidth}?address=\fparam{\{address\}}\\\hspace*{0.1\textwidth}\&port=\fparam{\{port\}}\\\hspace*{0.1\textwidth}\&service\_definition=\fparam{\{service\_definition\}}\\\hspace*{0.1\textwidth}\&system\_name=\fparam{\{system\_name\}}}{ServiceRegistryUnregisterRequest}{\pref{Void} or \mref{Error}}
...
\osubsection{Query}{POST}{/serviceregistry/query}{ServiceQueryForm}{\pref{Array}$<$\mref{ServiceRegistryRequest}$>$ or \mref{Error}}
